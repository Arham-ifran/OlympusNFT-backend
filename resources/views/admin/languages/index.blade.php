            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title float-sm-left">Languages</h3>
                        @if (Auth::user()->can('Add Language') || Auth::user()->hasRole('Super Admin'))
                        <a class="btn btn-primary float-sm-right" href="{{url('/admin/languages/create')}}">Add Languages</a>
                        @endif
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
