            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title float-sm-left">Musicians</h3>
                        {{--<a class="btn btn-primary float-sm-right" href="{{url('/admin/musicians/create')}}">Add Musician</a>
                        --}}
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
...
<script type="text/javascript">
    $(document).ready(function() {
        var table = $('#datatable').DataTable({
            ...
            serverSide: true,
            ajax: "{{ route('admin.musicians.index') }}",
