            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title float-sm-left">Banners</h3>
                        @if (Auth::user()->can('Add Banner') || Auth::user()->hasRole('Super Admin'))
                        <a class="btn btn-primary float-sm-right" href="{{url('/admin/banners/create')}}">Add Banner</a>
                        @endif
