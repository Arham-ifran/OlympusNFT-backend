...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Blogs Categories</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title float-sm-left">Blogs Categories</h3>
                        @if (Auth::user()->can('Add Blog Categories') || Auth::user()->hasRole('Super Admin'))
                        <a class="btn btn-primary float-sm-right" href="{{url('/admin/blog-categories/create')}}">Add Blog Category</a>
                        @endif
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
