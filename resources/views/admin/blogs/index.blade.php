            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title float-sm-left">Blogs</h3>
                        @if (Auth::user()->can('Add Blog') || Auth::user()->hasRole('Super Admin'))
                        <a class="btn btn-primary float-sm-right" href="{{url('/admin/blogs/create')}}">Add blog</a>
                        @endif
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
