            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title float-sm-left">Video Guides</h3>
                        @if (Auth::user()->can('Add Video Guides') || Auth::user()->hasRole('Super Admin'))
                        <a class="btn btn-primary float-sm-right" href="{{url('/admin/video-guides/create')}}">Add Video Guide</a>
                        @endif
...
<script type="text/javascript">
    $(document).ready(function() {
        var table = $('#datatable').DataTable({
            ...
            serverSide: true,
            ajax: "{{ route('admin.video-guides.index') }}",
