            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title float-sm-left">Categories</h3>
                        @if (Auth::user()->can('Add Category') || Auth::user()->hasRole('Super Admin'))
                        <a class="btn btn-primary float-sm-right" href="{{url('/admin/categories/create')}}">Add Category</a>
                        @endif
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
