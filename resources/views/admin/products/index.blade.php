            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title float-sm-left">Products</h3>

                        @if (Auth::user()->can('Add Product') || Auth::user()->hasRole('Super Admin'))
...
<script type="text/javascript">
   $(document).ready(function() {
        var store = "{{ $store }}";
         var q = '';
        // if ("undefined" !== typeof store && store != '') {
        //     q = '?store=' + store;
        // }
    ...
    if(store = "{{ $store }}"){
            $('#stor-id,#users-id').addClass('store_var');
        }
