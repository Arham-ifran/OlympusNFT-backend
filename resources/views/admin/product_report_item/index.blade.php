...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Products Report Items</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title float-sm-left">Report Items</h3>
...
<script type="text/javascript">
    $(document).ready(function() {
        var table = $('#datatable').DataTable({
            ...
            serverSide: true,
            ajax: "{{ route('admin.product-report-items.index') }}",
            ...
            columns: [
                ...
                {
                    data: 'product_report_abuses',
                    name: 'product_report_abuses'
                },

                {
                    data: 'let_us_know_why',
                    name: 'let_us_know_why'
                },
